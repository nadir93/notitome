...
const proc = {
  ...
  showMeTheMoney: function(client) {
    return new Promise((resolve, reject) => {
      let el;
      let size;
      let location;
  ...
  sendMessage: function(user) {
    ...
    web.chat.postMessage(config.channel, null, {
      'attachments': [{
        'fallback': saveMoney + '원이 적립되었습니다',
        'color': '#36a64f',
        'pretext': '`' + saveMoney + '`원이 적립되었습니다',
